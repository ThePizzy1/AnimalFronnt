  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4 text-white">
    ...
    <div v-if="additionalDetails.temperature"><strong>Temperature:</strong> {{ additionalDetails.temperature }}<strong> C°</strong></div>
       ...
       <div class="w-full overflow-x-auto">
        <div class="flex flex-col mx-4  px-10 py-10 relative">
          <table class="min-w-full leading-normal">
            <thead>
              <tr>
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Date of Disease Detection:</th>
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Symptoms:</th>
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Diagnosis:</th>
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Treatment:</th>
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Medication:</th>
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Severity of Disease:</th>
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Disease Description:</th>
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Recovery Time (days):</th>
                ...
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Recovery Date:</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="item in filteredItems" :key="item.idAnimal" class="border-b border-customBlack cursor-pointer" @click="navigateToDetails(item.idAnimal)">
                <td class="px-5 py-5 text-sm font-bold">{{ item.diseaseDetectionDate }}</td>
                <td class="px-5 py-5 text-sm font-bold">{{ item.symptoms }}</td>
                <td class="px-5 py-5 text-sm font-bold">{{ item.diagnosis }}</td>
                <td class="px-5 py-5 text-sm font-bold">{{ item.treatment }}</td>
                <td class="px-5 py-5 text-sm font-bold">{{ item.medication }}</td>
                <td class="px-5 py-5 text-sm font-bold">{{ item.diseaseSeverity }}</td>
                <td class="px-5 py-5 text-sm font-bold">{{ item.diseaseDescription }}</td>
                <td class="px-5 py-5 text-sm font-bold">{{ item.recoveryTime }}</td>
                <td class="px-5 py-5 text-sm font-bold">{{ item.notes }}</td>
                <td class="px-5 py-5 text-sm font-bold">{{ item.recoveryDate }}</td>
              </tr>
            </tbody>
          </table>
        </div>
