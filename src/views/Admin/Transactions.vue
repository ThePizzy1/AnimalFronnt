          ...
          <table class="min-w-full leading-normal ">
            <thead>
              <tr>
                ...
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Iban Animal Shelter</th>
                ...
                <th class="px-5 py-3 border-b-2 border-customBlack text-left text-sm font-bold text-white uppercase tracking-wider">Cost</th>
            ...
            <tbody>
              <tr v-for="item in items" :key="item.id" class="border-b border-customBlack cursor-pointer" @click="navigateToDetails(item.id)">
                ...
                <td class="px-5 py-5 text-sm font-bold text-left">{{ item.ibanAnimalShelter }}</td>
                ...
                <td class="px-5 py-5 text-sm font-bold text-left">{{ item.cost+" €" }}</td>
