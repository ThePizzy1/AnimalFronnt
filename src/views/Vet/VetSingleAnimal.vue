<template>
  ...
  <!--Modal medisines-->
       <div class="flex flex-col   size-fit">
        ...
        <div class=" p-6 bg-black rounded-lg shadow-lg  size-fit">
          <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200" >
                <h3 class="text-lg font-semibold text-gray-900 dark:text-stone-200">
                  Medicines
                </h3>
                <button @click="showMedicinesModal = false" type="button" class="text-gray-400 bg-transparent hover:bg-white hover:text-gray-900 rounded-lg text-base w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-stone-200" data-modal-toggle="crud-modal">
          ...
          <thead>
            <tr>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-gray-500 uppercase tracking-wider"></th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-gray-500 uppercase tracking-wider">Name</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-gray-500 uppercase tracking-wider">Descriptio</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-gray-500 uppercase tracking-wider">Vet</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-gray-500 uppercase tracking-wider">Amount Of Medicine</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-gray-500 uppercase tracking-wider">Medication Intake</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-gray-500 uppercase tracking-wider">Frequency Of Medication Use</th>
          ...
          <tbody>
            <tr v-for="medicine in filteredItems" :key="medicine.id" class="border-b border-customBlack cursor-pointer" >
              ...
              <td class="px-5 py-5 text-base font-bold text-center">{{ medicine.nameOfMedicines }}</td>
              <td class="px-5 py-5 text-base font-bold text-center">{{ medicine.description }}</td>
              <td class="px-5 py-5 text-base font-bold text-center">{{ medicine.vetUsername }}</td>
              <td class="px-5 py-5 text-base font-bold text-center" >{{ medicine.amountOfMedicine +medicine.mesurmentUnit }}</td>
              <td class="px-5 py-5 text-base font-bold text-center">{{ medicine.medicationIntake }} </td>
              <td class="px-5 py-5 text-base font-bold text-center">{{ medicine.frequencyOfMedicationUse }}</td>
