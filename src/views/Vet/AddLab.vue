        ...
        <form v-if(!submit) class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                      <div class="col-span-2 sm:col-span-1">
                                <label for="code" class="block mb-2 text-sm font-medium text-white dark:text-white">Animal code:</label>
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                  <label for="checkAnimal" class="block mb-2 text-sm font-medium text-white dark:text-white">Check</label>      
                        ...
                        <div class="col-span-2 sm:col-span-2">
                            <label for="dateAdd" class="block mb-2 text-sm font-medium text-white dark:text-white">Date</label>
              ...
              <!-- Form body -->
                 <form class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-2">
                            <label for="addParametarName" class="block mb-2 text-sm font-medium text-white dark:text-white">Name</label>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="addParametarValue" class="block mb-2 text-sm font-medium text-white dark:text-white">Value</label>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="addParametarMesurmentUnit" class="block mb-2 text-sm font-medium text-white dark:text-white">Measurement Units</label>
                    ...
                    <div class="col-span-2">
                          <label for="description" class="block mb-2 text-sm font-medium text-white dark:text-white">Remarks</label>
                      ...
                      <button @click="handleSubmit" type="submit" class=" mt-5 text-white inline-flex items-center bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">
                    ...
                    <button @click="isEditing==true" type="submit" class=" mt-5 text-white inline-flex items-center bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">
                      Done 
