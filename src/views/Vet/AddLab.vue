        ...
        <form v-if(!submit) class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                      <div class="col-span-2 sm:col-span-1">
                                <label for="code" class="block mb-2 text-base font-medium text-white dark:text-white">Animal code:</label>
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                  <label for="checkAnimal" class="block mb-2 text-base font-medium text-white dark:text-white">Check</label>      
                                  <svg @click="checkAnimal(this.addAnimalId)" class="w-8 h-8 ml- text-white dark:text-white cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m21 21-3.5-3.5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z"/>
                                  </svg>
                                </div>
                        <div class="col-span-2 sm:col-span-2">
                            <label for="dateAdd" class="block mb-2 text-base font-medium text-white dark:text-white">Date</label>
              ...
              <!-- Form body -->
                 <form class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-2">
                            <label for="addParametarName" class="block mb-2 text-base font-medium text-white dark:text-white">Name</label>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="addParametarValue" class="block mb-2 text-base font-medium text-white dark:text-white">Value</label>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="addParametarMesurmentUnit" class="block mb-2 text-base font-medium text-white dark:text-white">Measurement Units</label>
                    ...
                    <div class="col-span-2">
                          <label for="description" class="block mb-2 text-base font-medium text-white dark:text-white">Remarks</label>
                      ...
                      <button @click="handleSubmit" type="submit" class=" mt-5 text-white inline-flex items-center bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-base px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">
                    ...
                    <button @click="isEditing==true" type="submit" class=" mt-5 text-white inline-flex items-center bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-base px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">
                      Done 
