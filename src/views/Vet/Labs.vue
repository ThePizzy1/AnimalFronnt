<template>
  <div class="flex">
    ...
    <div class="w-5/6 text-white p-4 rounded-r-lg mr-8">
      ...
      <button type="button" @click="addLab" class="mb-4 text-white bg-emerald-400 hover:bg-emerald-500 focus:ring-3 focus:outline-none focus:ring-teal-300 font-medium rounded-full text-base p-1.5 text-center inline-flex items-center me-2 dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">
        ...
        <table class="min-w-full leading-normal">
          <thead>
            <tr>
              ...
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider">Animal Code</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider">Date</th>        
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider"></th>
            </tr>
          </thead>
          <tbody>
    ...
    <div class="relative  p-4 w-5xl h-full">
      ...
      <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="col-span-2 sm:col-span-1">
                  ...
                  <div class="relative py-4">
                    ...
                    <div class="relative flex justify-center">
                      <span class="bg-white px-4 text-base text-gray-500">Biometrics</span>
                    </div>
                  </div>
        ...
        <table class="min-w-full leading-normal ">
          <thead>
            <tr>
              <th class="px-5 py-3 border-b-2 border-gray-500  bg-gray-200 text-center text-base font-bold text-gray-600 uppercase tracking-wider">Name</th>
              <th class="px-5 py-3 border-b-2 border-gray-500  bg-gray-200  text-center text-base font-bold text-gray-600 uppercase tracking-wider">Value</th>
              <th class="px-5 py-3 border-b-2 border-gray-500  bg-gray-200 text-center text-base font-bold text-gray-600 uppercase tracking-wider">Remarks</th>        
            </tr>
          </thead>
          <tbody>
