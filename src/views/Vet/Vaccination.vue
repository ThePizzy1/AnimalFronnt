  ...
  <div class="flex">
    ...
    <div class="w-5/6 text-white p-4 rounded-r-lg mr-8">
      ...
      <button @click="add = true" type="button" class="mb-4 text-white bg-emerald-400 hover:bg-emerald-500 focus:ring-3 focus:outline-none focus:ring-teal-300 font-medium rounded-full text-sm p-1.5 text-center inline-flex items-center me-2 dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">
        ...
        <span class="block text-sm font-bold mx-2">Add Vaccination</span>
      </button>
      <div class="grid grid-cols-4 gap-4 mb-5">
      <div>
          <label for="startTime" class="block text-sm font-bold mb-2">Start Date:</label>
          <input v-model="filters.startTime" id="startTime" type="date" class="rounded-full border border-gray-300 text-white w-full py-2 px-3 bg-transparent  shadow-xl focus:outline-none focus:ring-emerald-500 focus:border-emerald-500" />
        </div>
        <div>
