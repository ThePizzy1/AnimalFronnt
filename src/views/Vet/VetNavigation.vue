<template>
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto bg-black text-stone-200">
        <div class="flex flex-shrink-0 items-center mb-10">
          <svg class="mr-2 w-auto h-10 fill-[#fcfcfc]" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
...
<path d="M192 48c0-26.5 21.5-48 48-48H400c26.5 0 48 21.5 48 48V512H368V432c0-26.5-21.5-48-48-48s-48 21.5-48 48v80H192V48zM48 96H160V512H48c-26.5 0-48-21.5-48-48V320H80c8.8 0 16-7.2 16-16s-7.2-16-16-16H0V224H80c8.8 0 16-7.2 16-16s-7.2-16-16-16H0V144c0-26.5 21.5-48 48-48zm544 0c26.5 0 48 21.5 48 48v48H560c-8.8 0-16 7.2-16 16s7.2 16 16 16h80v64H560c-8.8 0-16 7.2-16 16s7.2 16 16 16h80V464c0 26.5-21.5 48-48 48H480V96H592zM312 64c-8.8 0-16 7.2-16 16v24H272c-8.8 0-16 7.2-16 16v16c0 8.8 7.2 16 16 16h24v24c0 8.8 7.2 16 16 16h16c8.8 0 16-7.2 16-16V152h24c8.8 0 16-7.2 16-16V120c0-8.8-7.2-16-16-16H344V80c0-8.8-7.2-16-16-16H312z"></path>
      ...
      <h2 class="text-base lg:text-base text-customGreen">Animal Rescue VET</h2>
        ...
        <ul class="space-y-2 font-medium">
             ...
             <li>
              <router-link to="/vetProfile" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
                <svg class="w-6 h-6 text-stone-200 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              <path fill-rule="evenodd" d="M17 10v1.126c.367.095.714.24 1.032.428l.796-.797 1.415 1.415-.797.796c.188.318.333.665.428 1.032H21v2h-1.126c-.095.367-.24.714-.428 1.032l.797.796-1.415 1.415-.796-.797a3.979 3.979 0 0 1-1.032.428V20h-2v-1.126a3.977 3.977 0 0 1-1.032-.428l-.796.797-1.415-1.415.797-.796A3.975 3.975 0 0 1 12.126 16H11v-2h1.126c.095-.367.24-.714.428-1.032l-.797-.796 1.415-1.415.796.797A3.977 3.977 0 0 1 15 11.126V10h2Zm.406 3.578.016.016c.354.358.574.85.578 1.392v.028a2 2 0 0 1-3.409 1.406l-.01-.012a2 2 0 0 1 2.826-2.83ZM5 8a4 4 0 1 1 7.938.703 7.029 7.029 0 0 0-3.235 3.235A4 4 0 0 1 5 8Zm4.29 5H7a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h6.101A6.979 6.979 0 0 1 9 15c0-.695.101-1.366.29-2Z" clip-rule="evenodd"/>
                ...
                <span class="ms-3">Profile VET</span>
              </router-link>
            </li>
            <li>
              <router-link to="/vetAllAnimals" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
                ...
                <span class="ms-3">All Animals</span>
              </router-link>
            </li>
            <li>
              <router-link to="/animalsOnMedication" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
          ...
          <div class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-700 group" @click="toggleDropdown('visits')">
            <div class="flex items-center">
              <svg class="w-5 h-5 text-stone-200 dark:text-stone-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          ...
          <ul v-show="dropdowns.visits" class="pl-4 space-y-2">
            <li>
              <router-link to="/vacination" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
                ...
                <span class="ms-3">Vaccination</span>
              </router-link>
            </li>

            <li>
          <router-link to="/quarantine" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
         ...
         <span class="flex-1 ms-3 whitespace-nowrap">Quarantine</span>
        </router-link>
          </li>
          <li>
          <router-link to="/operations" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
         ...
         <span class="flex-1 ms-3 whitespace-nowrap">Operations</span>
          ...
          <li>
          <router-link to="/checkups" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
       ...
       <!--   <li>
          <router-link to="/labs" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
            <svg class="w-5 h-5 fill-[#fcfcfc]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
         ...
         <span class="flex-1 ms-3 whitespace-nowrap">Labs</span>
        </router-link>
          </li>-->

          <li>
          <router-link to="/approdeAdoption" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
          <svg class="w-5 h-5 fill-[#ffffff]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
         ...
         <span class="flex-1 ms-3 whitespace-nowrap">Approvd Adoption</span>
        </router-link>
          </li> 
         <!--!<li>
              <router-link to="/notCurableAnimals" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
                <svg class="w-5 h-5 fill-[#ffffff]" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="ms-3">Not Curable Animals</span>
              </router-link>
            </li> -->
            <li>
              <router-link to="/euthanasia" class="flex items-center p-2 rounded-lg hover:bg-gray-700 group">
  ...
  <path d="m12.75 20.66 6.184-7.098c2.677-2.884 2.559-6.506.754-8.705-.898-1.095-2.206-1.816-3.72-1.855-1.293-.034-2.652.43-3.963 1.442-1.315-1.012-2.678-1.476-3.973-1.442-1.515.04-2.825.76-3.724 1.855-1.806 2.201-1.915 5.823.772 8.706l6.183 7.097c.19.216.46.34.743.34a.985.985 0 0 0 .743-.34Z"/>
                ...
                <span class="ms-3">Euthanasia</span>
              </router-link>
            </li>
        <router-link to="/" :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-base text-gray-700']">
  ...
  /*Animals->Animal->prikazuje bolesti*/
  </style>
