        ...
        <table class="min-w-full leading-normal">
          <thead>
            <tr>
              ...
              <th class="px-5 py-3 border-b-2 border-customBlack text-right text-sm font-bold text-white uppercase tracking-wider">Height</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-right text-sm font-bold text-white uppercase tracking-wider">Width</th>
          ...
          <tbody>
            <tr v-for="item in filteredItems" :key="item.id" class="border-b border-customBlack cursor-pointer" @click="navigateToDetails(item.id)">
              ...
              <td class="px-5 py-5 text-sm font-bold text-right">{{ item.hight }} cm</td>
              <td class="px-5 py-5 text-sm font-bold text-right">{{ item.width }} cm</td>
