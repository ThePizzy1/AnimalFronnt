        ...
        <table class="min-w-full leading-normal">
          <thead>
            <tr>
              ...
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider">Brand Name</th>
              ...
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider">Toy Type</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider">Animal Type</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider">Age Group</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider">Quantity</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider">Price</th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider"></th>
              <th class="px-5 py-3 border-b-2 border-customBlack text-center text-base font-bold text-white uppercase tracking-wider"></th>
            </tr>
          </thead>
            ...
            <form @submit.prevent="handleSubmit" class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-2">
                  <div class="col-span-2 sm:col-span-1">
                        <label for="name" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Brand Name</label>
                    ...
                    <div class="col-span-2 sm:col-span-2">
                        <label for="intake" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Toy Type</label>
                    ...
                    <div class="col-span-2 sm:col-span-2">
                        <label for="intake" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Animal Type</label>
                    ...
                    <div class="col-span-2 sm:col-span-2">
                        <label for="intake" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Age Group</label>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="intake" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Width</label>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="intake" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Heigh</label>
      ...
      <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
        ...
        <form class="p-4 md:p-5">
          <div class="grid gap-4 mb-4 grid-cols-2">
            ...
            <div class="col-span-2 sm:col-span-1">
              <label for="singleName" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Toy Type</label>
            ...
            <div class="col-span-2 sm:col-span-1">
              <label for="singleName" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Animal Type</label>
              <span type="text" id="singleName"  class="bg-gray-50 border border-emerald-300 text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" readonly>
            ...
            <div class="col-span-2  sm:col-span-1">
              <label for="singleDate" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Width</label>
              <span type="date" id="singleDate"  class="bg-gray-50 border border-emerald-300 text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" readonly>
            ...
            <div class="col-span-2  sm:col-span-1">
              <label for="singleDate" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Hight</label>
              <span type="date" id="singleDate"  class="bg-gray-50 border border-emerald-300 text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" readonly>
