             ...
             <div class="w-5/6 text-white p-4 rounded-r-lg mr-8">
                    ...
                    <div class="overflow-x-auto shadow-2lx sm:rounded-lg">
                        ...
                        <thead>
                            ...
                            <th class="px-5 py-3 border-b-2 border-customBlack text-left text-base font-bold text-white uppercase tracking-wider">Iban</th>
                            <th class="px-5 py-3 border-b-2 border-customBlack text-left text-base font-bold text-white uppercase tracking-wider">Type</th>
                            ...
                            <th class="px-5 py-3 border-b-2 border-customBlack text-left text-base font-bold text-white uppercase tracking-wider">Balance</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <form class="p-4 md:p-5">
          <div class="grid gap-4 mb-4 grid-cols-2">
            <div class="col-span-2 ">
              <label for="singleCode" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Iban</label>
            ...
            <div class="col-span-2 ">
              <label for="singleCode" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Type</label>
              <span type="text" id="singleCode"  class="bg-gray-50 border border-emerald-300 text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" readonly>
              {{ this.singleItem.type }}
            </span>
            </div>
            <div class="col-span-2 ">
              <label for="animalName" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Date</label>
            ...
            <div class="col-span-2">
              <label for="singleName" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Balance</label>
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
               ...
               <form class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="ibanAdd" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Iban</label>
                    ...
                    <div class="col-span-2">
                        <label for="typeAdd" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Type</label>
                    ...
                    <div class="col-span-2 sm:col-span-2">
                        <label for="passwordConfirm" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Confirm Password</label>
                ...
                <button @click="handleSubmit()" type="submit" class="text-white inline-flex items-center bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-base px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">
